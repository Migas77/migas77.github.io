...
function loadFenceItem(position, rotation_y, material) {
    ...
    const fenceSupport1 = new THREE.Mesh( fenceSupportGeometry1, material );
    ...
    const fenceSupport2 = new THREE.Mesh( fenceSupportGeometry2, material );
    ...
    const fenceFront1 = new THREE.Mesh( fenceFrontGeometry1, material );
    ...
    const fenceFront2 = new THREE.Mesh( fenceFrontGeometry2, material );
