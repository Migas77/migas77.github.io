...
const scene = {
    ...
    load3DObjects: function (sceneGraph) {
        ...
        loadImage("images/under19s_promotionDetails.png", 7, 7, {x:19.34, y:0.012, z:2.7}, -Math.PI/2)
        loadButton(7.5, 1.4, {x: 19.34, z: 2.7}, 0x000000, "Subida", "Redirect", () => open_link("https://www.jb.pt/2022/04/juniores-do-anadia-sobem-a-1-a-divisao-nacional-26-anos-depois/"))
        ...
        loadImage("images/KeyUsageProfilerDetails.png", 7, 7, {x:19.11, y:0.011, z:10.7}, -Math.PI/2)
        loadButton(7.5, 1.4, {x: 19.34, z: 10.7}, 0x000000, "KeyUsageProfiler", "Redirect", () => open_link("https://github.com/miguel-silva48/KeyUsageProfiler"))
